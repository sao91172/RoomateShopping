...
//        AppCompatDelegate.setDefaultNightMode( AppCompatDelegate.MODE_NIGHT_YES );
        ...
        Log.d( DEBUG_TAG, "Roommate Shopping: MainActivity.onCreate()" );
    ...
    private class SignInButtonClickListener implements View.OnClickListener {
        ...
        public void onClick( View v ) {
            ...
            Log.d( DEBUG_TAG, "Roomate Shopping.SignInButtonClickListener: Signing in started" );
...
//            startActivity( intent );
    ...
    protected void onStart() {
        Log.d( DEBUG_TAG, "Roommate Shopping: MainActivity.onStart()" );
        super.onStart();
    }

    @Override
    protected void onResume() {
        Log.d( DEBUG_TAG, "Roommate Shopping: MainActivity.onResume()" );
        super.onResume();
    }

    @Override
    protected void onPause() {
        Log.d( DEBUG_TAG, "Roommate Shopping: MainActivity.onPause()" );
        super.onPause();
    }

    @Override
    protected void onStop() {
        Log.d( DEBUG_TAG, "Roommate Shopping: MainActivity.onStop()" );
        super.onStop();
    }
