...
public class SettleCostActivity extends AppCompatActivity implements AddItemDialogFragment.AddItemDialogListener, EditItemDialogFragment.EditItemDialogListener {
    private RecyclerView recyclerView;
    private PurchasedRecyclerAdapter purchasedRecyclerAdapter;
    private List<Item> itemList;
    private FirebaseDatabase db;

    double totalPrice, calculatedPrice;
    int NumOfUsers; //
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        Button checkoutButton = findViewById(R.id.button6);
        RecyclerView recyclerView = findViewById(R.id.purchasedRecycledItem);
        checkoutButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                calculatedPrice = totalPrice/ (double)NumOfUsers;

                Bundle args = new Bundle();
                Intent intent = new Intent(view.getContext(), TotalCostPageActivity.class);
                intent.putExtra("cost", calculatedPrice);
        ...
        purchasedRecyclerAdapter = new PurchasedRecyclerAdapter( itemList, SettleCostActivity.this );
        recyclerView.setAdapter(purchasedRecyclerAdapter );
        ...
        myRef.addValueEventListener( new ValueEventListener() {
            ...
            public void onDataChange( @NonNull DataSnapshot snapshot ) {
                ...
                purchasedRecyclerAdapter.notifyDataSetChanged();
            }
    ...
    public void updateItem( int position, Item item, int action ) {
        if( action == EditItemDialogFragment.SAVE ) {
            ...
            purchasedRecyclerAdapter.notifyItemChanged( position );
            ...
            purchasedRecyclerAdapter.notifyItemRemoved( position );
